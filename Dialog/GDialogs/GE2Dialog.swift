...
struct GE2DialogExpandable: View {
...
struct GE2Dialog: View {
    var body: some View {
        GE2DialogExpandable(currentContentIndex: .constant(0), dialogOpacity: .constant(1.0))
            .padding()
    }
}

struct GE2Dialog_Previews: PreviewProvider {
